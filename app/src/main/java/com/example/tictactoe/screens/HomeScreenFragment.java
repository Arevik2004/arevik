...
public class HomeScreenFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        AppCompatButton navSettingsButton = view.findViewById(R.id.button_nav_settings);
        ...
        navSettingsButton.setOnClickListener(currentView -> {
            if(isAdded()) requireActivity()
                    .getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.fragment_container_main, SettingsFragment.newInstance())
                    .addToBackStack(null)
                    .commit();
        });
    }
